  ...
  return (
    <section className="min-h-[55dvh] lg:min-h-[40dvh] flex justify-center items-center py-5">
      <div className="text-center space-y-9 lg:space-y-12">
        <div>
          <span className="border-2 py-2 px-4 lg:px-16 rounded-md border-dashed border-violet-500 text-violet-500 text-sm lg:text-base shadow-[0px_20px_207px_10px_rgba(165,_39,_255,_0.48)]">
        ...
        <div className="max-w-4xl space-y-4 lg:space-y-2.5">
          ...
          <p className="text-base lg:text-lg tracking-wide text-gray-700 font-light px-3.5">
            <span className="font-medium capitalize leading-relaxed">
              bisa interview
            </span>{" "}
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fuga,
            incidunt labore! Provident, ab dicta.
          </p>
        </div>
      </div>
    </section>
